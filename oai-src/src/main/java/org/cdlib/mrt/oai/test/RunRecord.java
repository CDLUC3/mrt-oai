...
{
    private static final String NAME = "RunRecord";
    ...
    public static void main(String args[])
    {
        ...
        try {
            ...
            OAIId id = OAIId.getArkId("ark:/13030/oai002");
            
            TestRecord test = new TestRecord(metaType, connect, logger);
            String out = test.process(id);
