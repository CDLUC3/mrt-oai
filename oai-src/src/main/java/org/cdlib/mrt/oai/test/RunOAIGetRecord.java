...
import org.cdlib.mrt.oai.xoai.OAIGetRecord;
...
public class RunOAIGetRecord
{
    private static final String NAME = "RunGetRecord";
    ...
    public static void main(String args[])
    {
        ...
        try {
            ...
            OAIId id = OAIId.getArkId("ark:/99999/fk4mk6hz03");
            ...
            OAIGetRecord oaiRecords = new OAIGetRecord(
                id.getN2T(),
