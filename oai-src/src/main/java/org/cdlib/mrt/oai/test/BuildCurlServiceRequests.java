...
public class BuildCurlServiceRequests
{
            ...
            throws Exception
    {
        ...
        try {
            ...
            from = OAIDate.getDBDate("2015-07-14 15:00:00");
            until = OAIDate.getDBDate("2015-07-14 15:59:00");
            
            id = OAIId.getArkId("ark:/99999/fk4mk6hz03");
            mnemonic = "dash_cdl";
